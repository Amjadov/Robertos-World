...
public class BackgroundPropSpawner : MonoBehaviour
{
	...
	IEnumerator Spawn ()
	{
		...
		Vector3 spawnPos = new Vector3 (posX, posY,transform.position.z + posY);//transform.position.z);
		...
		Transform Wheel1 = propInstance.transform.Find ("Wheel");
		if (Wheel1)
		Wheel1.position = new Vector3 (Wheel1.position.x, Wheel1.position.y, propInstance.transform.position.z );
		Transform Wheel2 = propInstance.transform.Find ("Wheel2");
		if (Wheel2)
		Wheel2.position = new Vector3 (Wheel2.position.x, Wheel2.position.y, propInstance.transform.position.z);
