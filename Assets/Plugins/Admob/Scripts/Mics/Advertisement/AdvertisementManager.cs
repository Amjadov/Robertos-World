...
//    }
		...
		/// </summary>
		[SerializeField]
		private AdvertisementHandler.AdvSize
				m_advSize = AdvertisementHandler.AdvSize.SMART_BANNER;
		...
		/// </summary>
		[SerializeField]
		private AdvertisementHandler.AdvOrientation
				m_orientation = AdvertisementHandler.AdvOrientation.HORIZONTAL;
		...
		/// </summary>
		[SerializeField]
		private AdvertisementHandler.Position
				m_positionOne = AdvertisementHandler.Position.BOTTOM;
		...
		[SerializeField]
		private AdvertisementHandler.Position
				m_positionTwo = AdvertisementHandler.Position.CENTER_HORIZONTAL;
		...
		[SerializeField]
		private string
				m_testDeviceId = "4965DFB7E2F16194A15150C45A6927A9";
		...
		/// </summary>
		[SerializeField]
		private AdvertisementHandler.AnimationInType
				m_animationInType = AdvertisementHandler.AnimationInType.SLIDE_IN_LEFT;
		...
		/// </summary>
		[SerializeField]
		private AdvertisementHandler.AnimationOutType
				m_animationOutType = AdvertisementHandler.AnimationOutType.FADE_OUT;
		...
		/// </summary>
		[SerializeField]
		private AdvertisementHandler.LevelOfDebug
				m_levelOfDebug = AdvertisementHandler.LevelOfDebug.LOW;
